...
dict1={1:"asher1",2:"the men1"}
dict2={1:"host_name",2:"switch_ver",3:"product_model",4:"ip_address",5:"vc_count",7:"re_cpu",8:"re_memory"}
print (dict_to_excel(dict2,"device_report.xlsx"))
